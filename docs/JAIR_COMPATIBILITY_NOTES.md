...
### 1. Header File Updates (`mini_jiminy/mini_jiminy.hpp`)
...
### 2. YAML Loader Updates (`mini_jiminy_node.cpp`)
...
### 3. Implementation Files (`mini_jiminy.cpp`)
...
```
jiminy_ros/src/mini_jiminy_bringup/scenarios/jair.yaml
```
