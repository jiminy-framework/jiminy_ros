...
# agriculture_demo/demo_priority.yaml (2 norms, 1 fact, 2 contraries)
...
# Load agriculture_demo/demo_priority.yaml PASS Loaded 2 norms
...
chmod +x test\_\*.py run_all_tests.sh
